...
const ClientStory = () => {
  return (
    <div className="relative flex bg-gray-200 justify-center w-screen h-full py-32 ">
        <div className="grid grid-cols-12">
                   
            <div className="bg-cover bg-center bg-no-repeat bg-[url('./assets/Middleware/backgroundMiddleware.png')] md:col-start-3 md:col-span-8 col-span-12">
                ...
                <div className="relative translate-y-[0px] md:translate-y-[-50px]">
